...
- (void)startAuthorize
{
    ...
    [webView release];*/
    NSLog(@"%@",urlString);
    WBAuthorizeWebView *auth = [[WBAuthorizeWebView alloc] initWithURL:[NSURL URLWithString:urlString] delegate:self];
...
- (void)authorizeWebView:(WBAuthorizeWebView *)webView didReceiveAuthorizeCode:(NSString *)code
{
    ...
    //[webView hide:YES];modify by merlin
...
#pragma mark - SHKOAuthViewDelegate Methods
- (void)authorizeOAuthView:(SHKOAuthView *)webView didReceiveAuthorizeCode:(NSString *)code;
{
    // if not canceled
    if (![code isEqualToString:@"21330"])
    {
