...
// Sina Weibo 
#define SHKSinaWeiboConsumerKey         @"3811971339"	// The consumer key
#define SHKSinaWeiboConsumerSecret      @"a03d34827717904bd0018aaaa1e94335"	// The secret key
#define SHKSinaWeiboCallbackUrl         @"http://www.i-md.com"	// You need to set this if using OAuth (MUST be set, it could be any words)
...
// Tencent Weibo add by 2012-5-4
#define SHKTencentWeiboConsumerKey         @"801138188"	// The consumer key
#define SHKTencentWeiboConsumerSecret      @"0a07924923996f4d38a7c31358b44de2"/*"60507c70cc84c52dc44b86f421b75ca"*/	// The secret key
#define SHKTencentWeiboCallbackUrl         @"oauth://i-md.com"	// You need to set this if using OAuth (MUST be set, it could be any words)
#define SHKTencentWeiboUseXAuth            0   // To use xAuth, set to 1
#define SHKTencentWeiboScreenName          @"" // Enter your sina weibo screen name (Only for xAuth)
#define SHKTencentWeiboUserID              @"" // Enter your app's sina weibo account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
...
// NetEase(163) Weibo 
#define SHKNetEaseWeiboConsumerKey      @"sh7fWOnxE6ZcA1AB"	// The consumer key
#define SHKNetEaseWeiboConsumerSecret   @"LjTMNLMC3s3hpiyutjX2huvCyHnLPhcr"	// The secret key
